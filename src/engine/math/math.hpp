...
struct Vector3 {
    ...
    static inline T dot(const Vector3<T> &a, const  Vector3<T> &b) {
        return a.dot(b);
    }
};
...
struct Matrix4 {
    ...
    void operator *=(Matrix4<T> &that) {
            elems[0]  = elems[0]*that[0]  + elems[1]*that[4]  + elems[2]*that[8]   + elems[3]*that[12];  /// r0*c0
            elems[1]  = elems[0]*that[1]  + elems[1]*that[5]  + elems[2]*that[9]   + elems[3]*that[13];  /// r0*c1
            elems[2]  = elems[0]*that[2]  + elems[1]*that[6]  + elems[2]*that[10]  + elems[3]*that[14];  /// r0*c2
            elems[3]  = elems[0]*that[3]  + elems[1]*that[7]  + elems[2]*that[11]  + elems[3]*that[15];  /// r0*c3

            elems[4]  = elems[4]*that[0]  + elems[5]*that[4]  + elems[6]*that[8]   + elems[7]*that[12];  /// r1*c0
            elems[5]  = elems[4]*that[1]  + elems[5]*that[5]  + elems[6]*that[9]   + elems[7]*that[13];  /// r1*c1
            elems[6]  = elems[4]*that[2]  + elems[5]*that[6]  + elems[6]*that[10]  + elems[7]*that[14];  /// r1*c2
            elems[7]  = elems[4]*that[3]  + elems[5]*that[7]  + elems[6]*that[11]  + elems[7]*that[15];  /// r1*c3

            elems[8]  = elems[8]*that[0]  + elems[9]*that[4]  + elems[10]*that[8]  + elems[11]*that[12]; /// r2*c0
            elems[9]  = elems[8]*that[1]  + elems[9]*that[5]  + elems[10]*that[9]  + elems[11]*that[13]; /// r2*c1
            elems[10] = elems[8]*that[2]  + elems[9]*that[6]  + elems[10]*that[10] + elems[11]*that[14]; /// r2*c2
            elems[11] = elems[8]*that[3]  + elems[9]*that[7]  + elems[10]*that[11] + elems[11]*that[15]; /// r2*c3

            elems[12] = elems[12]*that[0] + elems[13]*that[4] + elems[14]*that[8]  + elems[15]*that[12]; /// r3*c0
            elems[13] = elems[12]*that[1] + elems[13]*that[5] + elems[14]*that[9]  + elems[15]*that[13]; /// r3*c1
            elems[14] = elems[12]*that[2] + elems[13]*that[6] + elems[14]*that[10] + elems[15]*that[14]; /// r3*c2
            elems[15] = elems[12]*that[3] + elems[13]*that[7] + elems[14]*that[11] + elems[15]*that[15]; /// r3*c3
    }
